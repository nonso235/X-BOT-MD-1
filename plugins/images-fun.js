...
let wm = `
©ᴘᴏᴡᴇʀᴇᴅ ʙʏ Dᴀᴠɪᴅ X`
await conn.sendMessage(from, { image: { url: res.data.content.imageHigh }, caption: wm}, { quoted: mek })
} catch (e) {
reply(cants)
console.log(e)
}
...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        await conn.sendMessage(from, { image: { url: data.message }, caption: '> *© Powered By X-md> ' }, { quoted: mek });
    } catch (e) {
        console.log(e); // ❯❯ Powered 
