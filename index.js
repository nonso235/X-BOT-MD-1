...
async function downloadAndExtractZip(zipUrl) {
  ...
  try {
    if (allRequiredItemsExist()) {
      console.log("Skipped, for filles already exist.");
    } else {
      console.log("Required files not found. Downloading ZIP...");
...
const port = process.env.PORT || 9090;
  ...
  const udp = botNumber.split('@')[0];
    const david = ('12567980814', '234913335464');
    let isCreator = [udp, david, config.DEV]
