...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(from, {
            image: { url: config.MENU_IMAGE_URL || 'https://files.catbox.moe/yv8zy4.jpg' },
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    newsletterJid: '120363348038810906@newsletterr',
                    newsletterName: config.OWNER_NAME || 'David X',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
