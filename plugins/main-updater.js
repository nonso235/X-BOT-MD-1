...
cmd({
    ...
    try {
        ...
        const { data: commitData } = await axios.get("https://api.github.com/repos/Xbot-md/XBOT-FILE/commits/main");
        ...
        const { data: zipData } = await axios.get("https://github.com/Xbot-md/XBOT-FILE/archive/main.zip", { responseType: "arraybuffer" });
        ...
        const sourcePath = path.join(extractPath, "XBOT-FILE-main");
